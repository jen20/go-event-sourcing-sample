...
Save(aggregate Aggregate) (GlobalVersion, error)
...
Save(events []eventsourcing.Event) (GlobalVersion, error)
...
type EventStore interface {
	// The returned GlobalVersion is the last events global version stored to the event store
